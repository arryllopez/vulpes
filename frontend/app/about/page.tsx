...
export default function About() {
  const values = [
    ...
    },
    {
      ...
      description: "Every deal on Trivvi helps a restaurant thrive.",
    },
    {
      ...
      <main className="min-h-screen bg-white relative overflow-hidden">
        ...
        <section className="px-6 py-16 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-[#03045E] mb-6 font-(family-name:--font-caudex)">
                Our Story
              </h2>
        ...
        <section className="px-6 py-16 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <div className="inline-flex items-center gap-2 bg-[#abc4ff]/20 text-[#03045E] px-4 py-2 rounded-full text-sm font-semibold mb-6 font-(family-name:--font-caudex)">
        ...
        <section className="px-6 py-16 relative z-10">
          <div className="max-w-6xl mx-auto">
            <motion.h2
              ...
              viewport={{ once: true, amount: 0.3 }}
              transition={{ duration: 0.6 }}
              className="text-3xl md:text-4xl font-bold text-[#03045E] mb-12 text-center font-(family-name:--font-caudex)"
            >
              What We Believe
            </motion.h2>
        ...
        <section className="px-6 py-16 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-[#03045E] mb-4 font-(family-name:--font-caudex)">
                Built with passion
              </h2>
              <p className="text-lg text-[#03045E]/80 font-(family-name:--font-caudex) mb-6 max-w-2xl mx-auto">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white text-[#03045E] px-6 py-3 rounded-xl font-semibold hover:bg-white/90 transition-colors font-(family-name:--font-caudex)"
              >
