...
export default function About() {
  const values = [
    ...
    },
    {
      ...
      title: "Hyper-Local",
      description: "Foods that matter, where you are. Trivvi understands that the best meal is often the one closest to you. So you can discover awesome food spots just around the corner.",
    },
  ];
