        ...
        <article className="max-w-4xl mx-auto px-6 py-24">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-10">
              ...
              <p className="text-gray-700 mb-4">
                Our Service uses location data to connect diners with nearby restaurant offers. We collect:
              </p>
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
                ...
                <li><strong>App Usage:</strong> Features used, offers viewed, and interactions within the app</li>
            ...
            <section className="mb-10">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
                <li><strong>Provide the Service:</strong> To operate our platform, connect diners with restaurants, and deliver location-based offer notifications</li>
            ...
            <section className="mb-10">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
                ...
                <li><strong>Restaurant Partners:</strong> Aggregated, anonymized data about offer performance (never individual user data)</li>
